...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@core': path.join(rootPath, 'src', 'core'),
      '@pages': path.join(rootPath, 'src', 'pages'),
      '@services': path.join(rootPath, 'src', 'services'),
      '@utils': path.join(rootPath, 'src', 'utils'),
      '@css': path.join(rootPath, 'src', 'static', 'css'),
      '@images': path.join(rootPath, 'src', 'static', 'images'),
      '@bower': path.join(rootPath, 'src', 'static', 'bower_components')
    },
    plugins: [
